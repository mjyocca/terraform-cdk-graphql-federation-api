...
class AdminApiStack extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new TerraformOutput(this, 'deployment-bucket', {
      value: remoteState.getString('lambdaDeploymentBucket'),
    });
...
new AdminApiStack(app, 'admin-api');
